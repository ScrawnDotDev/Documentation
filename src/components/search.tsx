...
function Header() {
  ...
  return (
    <div className="sticky top-0 flex items-start gap-2">
      <div className="flex-1 p-4 border rounded-2xl bg-fd-card text-fd-card-foreground">
  ...
  return (
    <Context value={useMemo(() => ({ chat, open, setOpen }), [chat, open])}>
      ...
      <Presence present={open}>
        <div
          className={cn(
            'fixed flex flex-col inset-y-2 p-2 bg-fd-popover text-fd-popover-foreground border rounded-3xl shadow-xl z-30 sm:w-[460px] sm:end-2 max-sm:inset-x-2',
            open
      ...
      <button
        className={cn(
          'fixed flex items-center gap-2 bottom-4 bg-fd-card text-fd-foreground px-4 h-11 text-sm font-medium rounded-full border shadow-lg z-20 transition-all hover:bg-fd-accent hover:shadow-xl hover:scale-[1.02]',
