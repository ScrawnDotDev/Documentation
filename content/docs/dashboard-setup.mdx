...
- [Scrawn backend deployed](/docs/backend-deployment) and running
- Database URL (same PostgreSQL database as your backend)
- Initial API key generated from [Quick Start](/docs/quick-start#5-generate-initial-api-key)
...
**SCRAWN_KEY:** The initial API key you generated in the [Quick Start guide](/docs/quick-start#5-generate-initial-api-key)
</Callout>
