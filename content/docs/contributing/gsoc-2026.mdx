...
- **gRPC Backend**: High-performance event-driven server with PostgreSQL, and HTTP/2 ([github.com/ScrawnDotDev/Scrawn](https://github.com/ScrawnDotDev/Scrawn))
...
1. **Explore the project**: Try deploying Scrawn locally using our [Quick Start](/quick-start) guide
2. **Make a contribution**: Fix a bug or improve documentation to familiarize yourself with the codebase
3. **Join our community**: Introduce yourself on [Discord](https://discord.gg/rkVmjJ4Zw5) and participate in discussions
...
**Repository**: [Documentation](https://github.com/ScrawnDotDev/Documentation)
...
- **Backward Compatible**: Drop-in replacement for the existing `APIKeyCache` class interface
- **Configurable TTL**: Maintain existing 5-minute TTL but make it configurable
...
**Expected Outcomes**:
- `RedisAPIKeyCache` class implementing existing cache interface
- Redis pub/sub system for revocation notifications
...
- **Discord**: [Join our community](https://discord.gg/rkVmjJ4Zw5) for real-time discussions
