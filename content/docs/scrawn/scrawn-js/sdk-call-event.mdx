...
<Callout type="info">
**In simple terms:** Charge user `user-123` an amount of `100` or a backend price tag.
</Callout>
...
### `debitTag` (optional)
- **Type:** `string`
- **Description:** Price tag configured in your backend to look up billing amount
- **Validation:** Must be a non-empty string
- **Example:** `STANDARD_API_CALL`, `PREMIUM_FEATURE`
...
<Cards>
  <Card href="/scrawn-js/collect-payment" title="Collect Payment">
