...
See the [Dashboard Setup Guide](/dashboard-setup) for details.
</Callout>
...
<Cards>
  <Card href="/backend-deployment" title="Backend Deployment">
    Learn how to deploy your Scrawn backend to production
  </Card>
</Cards>

<Callout type="info" title="Local Testing">
For easy local testing, refer [local running guide](/backend-deployment#running-locally).
</Callout>
...
// Track usage with direct amount
await scrawn.sdkCallEventConsumer({ 
  userId: '0a1e38a5-e2f3-450f-9796-59ad406d93dc', 
  debitAmount: 5000,
});

// Or track usage with a backend price tag
await scrawn.sdkCallEventConsumer({ 
  userId: '0a1e38a5-e2f3-450f-9796-59ad406d93dc', 
...
**API Key:** Use the key you generated in [Step 5](#5-generate-initial-api-key) or get one from your [Dashboard](/dashboard-setup#creating-a-new-api-key).
...
<Cards>
  <Card href="/scrawn-js/sdk-call-event" title="SDK Call Event Consumer">
    Learn how to track events and usage in detail
  </Card>
  <Card href="/scrawn-js/middleware-call" title="Middleware Call">
