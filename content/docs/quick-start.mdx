...
See the [Dashboard Setup Guide](/docs/dashboard-setup) for details.
</Callout>
...
**API Key:** Use the key you generated in [Step 5](#5-generate-initial-api-key) or get one from your [Dashboard](/docs/dashboard-setup#creating-a-new-api-key).
