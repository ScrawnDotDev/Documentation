...
See the [Dashboard Setup Guide](/docs/dashboard-setup) for details. {/* TODO: change this */}
</Callout>
...
For easy local testing, refer [local running guide](/docs/backend-deployment#running-locally).
</Callout>
...
**API Key:** Use the key you generated in [Step 5](#5-generate-initial-api-key) or get one from your [Dashboard](/docs/dashboard-setup). {/* TODO: change this */}
